...
docker exec kafka1 kafka-topics.sh --create --zookeeper 172.17.0.1:2181 --replication-factor 2 --partitions 2 --topic EVENT-CREATE-ORDER &
docker exec kafka1 kafka-topics.sh --create --zookeeper 172.17.0.1:2181 --replication-factor 2 --partitions 2 --topic EVENT-SUBMIT-TRANS
