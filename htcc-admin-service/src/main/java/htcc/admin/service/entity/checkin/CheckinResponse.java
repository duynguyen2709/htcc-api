package htcc.admin.service.entity.checkin;
...
public class CheckinResponse implements Serializable {
    ...
    @ApiModelProperty(notes = "Giờ cho phép thực hiện điểm danh vào (sau thời gian này là vào trễ)",
                      example = "08:30")
    public String validCheckinTime;

    @ApiModelProperty(notes = "Giờ cho phép thực hiện điểm danh ra (trước thời gian này là về trễ)",
                      example = "17:30")
    ...
    @ApiModelProperty(notes = "Giờ thực hiện điểm danh vào (empty nếu chưa điểm danh vào)",
                      example = "08:05")
    ...
    @ApiModelProperty(notes = "Giờ thực hiện điểm danh ra (empty nếu chưa điểm danh ra)",
                      example = "17:35")
